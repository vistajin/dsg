Select cast(0 as bit ) as selectflag,a.LocationID,a.MatNo,a.MatDesc,a.BatchID,a.volumeid,a.Package,                                                                                  
          ...
          reqd.pre_number,reqd.pre_line,pre.unit as preunit, case when pre.unit<>a.Lunit and pre.unit='磅' then (pre.needqty-ISNULL(pre.cancleQty,0)-ISNULL(pre.cancleQty2,0))*a.sampleqty/a.conversion                                  
                         else                                   
          ...
          case when a.storeno in ('B','C') and a.avnoreslength-((case when pre.unit<>a.Lunit and pre.unit='磅' then pre.rtnqty*a.sampleqty/a.conversion                                  
               ...
               else a.avnoreslength  end as prerestqty   into #tmpmaterialsend                                   
