...
/****** Object:  StoredProcedure [dbo].[spMaterialByBatchID]    Script Date: 09/21/2017 11:36:20 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [dbo].[spMaterialByBatchID]                                                                                                                                                     
...
begin                                                
      set @sql='Select distinct cast(0 as bit ) as selectflag,                                              
          ...
          set @sql=@sql+' into #tmpmaterialsend                                      
              ...
              left join req_head reqh(nolock) on reqh.req_serial=reqd.req_serial                                                            left join vm_batchstoreqty a on a.orderserial=reqd.req_serial and a.line=reqd.req_line                            
...
begin                                                                           
   ...
   SET @sql = @sql + 'where a.storelength>0 and a.storeweight>0 and a.avnoreslength >0 and a.avnoresweight>0                                                                                          
